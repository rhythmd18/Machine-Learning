...
def load_house_data():
    data = np.loadtxt("/workspaces/Machine-Learning/1 Supervised Machine Learning Regression and Classification/Week 2/Lab/data/houses.txt", delimiter=',', skiprows=1)
    X = data[:,:4]
    y = data[:,4]
    return X, y
